...
public class MyHashTable<AnyType>
{
    ...
    private int occupied;                 // The number of occupied position
    private int currentSize;              // current table size
    /**
    ...
    private void rehash( )
    {
        ...
        organizeArray( 2 * oldArray.length );
        occupied = 0;
        currentSize = 0;
    ...
    /**
     * Internal method to organize array.
     * @param arraySize the size of the array.
     */
    private void organizeArray( int arraySize )
    {
